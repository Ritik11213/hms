                    ...
                    <div class = "row">
                        <div class = "col-md-6">
                                ...
                                <form method = "post" entype = "multipart/form-data">
                                    <?php
                                    echo "<img src = 'img/$profiles' class = 'col-md-12'
                                    style = 'height: 250px;'>";
                                    ?>
                                    <br><br>
                        ...
                        <div class="col-md-6">
                            ...
                            if(isset($_POST['change'])) {
                                ...
                                if(empty($uname)) {
                                    ...
                                    $query = "UPDATE admit SET username='$uname' WHERE username='$ad'";
                            ...
                            <br>
                                ...
                                if(isset($_POST['update_pass'])) {
                                    ...
                                    $old = myysqli_query($connect,"SELECT * FROM admin WHERE username='$ad'");
